...
function sortRecordsByProperty(property, ascending, a, b) {
  return sortRecordsByGetter(r => getNestedProperty(r, property), ascending, a, b);
}
...
export { sortRecordsByName, sortRecordsByProperty, sortRecordsByGetter, getNestedProperty, setNestedProperty, oxfordCommaList };